...
public enum ErrorCode {
    ...
    INVITE_ONLY_ENROLLMENT(HttpStatus.FORBIDDEN, "SIS007", "This course only accepts invited users"),
    ENROLLMENT_PENDING_APPROVAL(HttpStatus.FORBIDDEN, "SIS008", "Enrollment is pending approval"),
    ...
    COMMUNITY_PRIVATE_POST_ACCESS_DENIED(HttpStatus.FORBIDDEN, "CMT007", "Not authorized to access this private post"),
    ...
    ROADMAP_FEATURE_DISABLED(HttpStatus.SERVICE_UNAVAILABLE, "RM008", "Roadmap feature is temporarily disabled"),
